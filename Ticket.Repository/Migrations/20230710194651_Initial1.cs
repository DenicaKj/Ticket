        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketProjectionRoom = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(nullable: false),
                    RoleId = table.Column<string>(nullable: false),
                    TicketApplicationUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_AspNetUsers_TicketApplicationUserId",
                        column: x => x.TicketApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketInMovies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TicketInMovies_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketInMovies_Tickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductInShoppingCarts_Tickets_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_TicketApplicationUserId",
                table: "AspNetUserRoles",
                column: "TicketApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketInMovies_MovieId",
                table: "TicketInMovies",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketInMovies_TicketId",
                table: "TicketInMovies",
                column: "TicketId");
